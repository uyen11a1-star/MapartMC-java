...
Dựng khung cổng rộng 4 block và cao 5 block bằng **Ancient Riftstone**, để trống phần trong. Cầm **Rift Sigil** rồi tương tác với block Ancient Riftstone ở góc dưới bên trái của khung. Cổng sẽ tạo mặt rift tím-cyan và cho phép đi hai chiều giữa Overworld và Aethel-Ruinium.
...
Vorath là entity riêng của RiftAncient, có model/texture riêng, 600 máu, giáp cao, AI truy đuổi, cận chiến, đòn **Rift Burst** tầm xa và giai đoạn **Enraged** khi còn dưới 35% máu. Khi bị đánh bại, Vorath rơi **Ruin Heart**.
...
Bộ giáp Aetherite và các công cụ Aetherite có texture riêng. Khi mặc đủ bốn mảnh giáp trong Aethel-Ruinium, người chơi nhận Resistance và Night Vision định kỳ. Công thức đầy đủ nằm trong `data/riftancient/recipe/` và phần hướng dẫn nguyên liệu ở thư mục source.
